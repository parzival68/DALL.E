...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) =>  // Here (e) is an argument of the function and 'e' is an event
  {
    e.preventDefault();
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Create imaginative and visually stunning images through AI Image Generator and share them with the community</p>
      </div>
